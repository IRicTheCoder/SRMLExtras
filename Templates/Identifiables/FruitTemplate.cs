...
namespace SRMLExtras.Templates
{
	...
	public class FruitTemplate : ModPrefab<FruitTemplate>
	{
		...
		public FruitTemplate(string name, Identifiable.Id ID, Material[] materials = null) : base(name)
		{
			this.ID = ID;
		...
		public FruitTemplate SetModelTrans(ObjectTransformValues trans)
		{
			modelTrans = trans;
			return this;
		}

		public FruitTemplate SetSpawnOptions(List<BreakOnImpact.SpawnOption> spawnOptions)
		{
